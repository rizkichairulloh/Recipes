  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Responsive(
          ...
          desktop: Center(
              child: Obx(() => !_recipesC.isLoading.value && _recipesC.detailRecipesList.isNotEmpty
                  ? Container(
                      width: Get.width / 3,
                      height: Get.height,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _field(
                                title: 'calories',
                                value:
                                    _recipesC.detailRecipesList[0].calories!),
                            const SizedBox(
                              height: 4,
                            ),
                            _field(
                            ...
                            _field(
                                title: 'difficulty',
                                value:
                                    _recipesC.detailRecipesList[0].difficulty!),
                            const SizedBox(
                              height: 4,
                            ),
                            _field(
